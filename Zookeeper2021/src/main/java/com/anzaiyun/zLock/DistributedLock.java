    ...
    public DistributedLock() throws IOException, InterruptedException, KeeperException {
        ...
        zk = new ZooKeeper(connectString, sessionTimeout, new Watcher() {
            ...
            public void process(WatchedEvent event) {
                ...
                // 发生了 waitPath 的删除事件
                if (event.getType() == Event.EventType.NodeDeleted && event.getPath().equals(waitPath)) {                     waitLatch.countDown();                 }             }         });
        ...
        try {
            ...
            if(childrenNodes.size() == 1){
                ...
                if (index == -1) {
                    ...
                    // 在 waitPath 上注册监听器, 当 waitPath 被删除时, zookeeper 会回调监听器的 process 方法                     zk.getData(waitPath, true, new Stat());                     //进入等待锁状态                     waitLatch.await();
